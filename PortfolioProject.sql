...
JOIN CovidVaccinations
 ...
 --Looking at Total Population VS Vaccination and displaying rolling count of people vaccinated
...
JOIN CovidVaccinations
 ...
 -- Use CTE to calculate the percentage of rolling people vaccinated from the total population
...
WHERE CovidDeaths.continent is NOT NULL
 ...
 -- Use TEMP Table calculate the percentage of rolling people vaccinated from the total population
